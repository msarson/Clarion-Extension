...
logger.info("🚀 SERVER: Starting to listen on connection [348-NAMES BUILD]");
console.error("🚀 SERVER: Starting to listen on connection [348-NAMES BUILD] at " + new Date().toISOString());
