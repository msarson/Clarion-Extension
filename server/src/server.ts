...
logger.info("🚀 SERVER: Starting to listen on connection [350B-345T BUILD]");
console.error("🚀 SERVER: Starting to listen on connection [350B-345T BUILD] at " + new Date().toISOString());
