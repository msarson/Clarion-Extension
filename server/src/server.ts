...
logger.info("🚀 SERVER: Starting to listen on connection [347-P3I2 BUILD]");
console.error("🚀 SERVER: Starting to listen on connection [347-P3I2 BUILD] at " + new Date().toISOString());
