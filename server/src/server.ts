...
logger.info("🚀 SERVER: Starting to listen on connection [352-356 BUILD]");
console.error("🚀 SERVER: Starting to listen on connection [352-356 BUILD] at " + new Date().toISOString());
