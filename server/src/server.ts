...
logger.info("🚀 SERVER: Starting to listen on connection [362-F12v2 BUILD]");
console.error("🚀 SERVER: Starting to listen on connection [362-F12v2 BUILD] at " + new Date().toISOString());
