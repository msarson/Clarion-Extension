...
logger.info("🚀 SERVER: Starting to listen on connection [361-F12 BUILD]");
console.error("🚀 SERVER: Starting to listen on connection [361-F12 BUILD] at " + new Date().toISOString());
