...
Window               WINDOW('Enter Your Password'),AT(,,388,339),FONT('Segoe UI',8,,FONT:regular),DOUBLE,CENTER, |
  ICON('acmmenu.ico'),GRAY,IMM,MASK,SYSTEM
                       SHEET,AT(3,2,383,305),USE(?SHEET1),WIZARD
                         TAB('Tab1'),USE(?TAB1)
                           ...
                           STRING(@s10),AT(170,193,,10),USE(GBL:Version),TRN
                           ...
                           STRING(@n_6),AT(170,206,46),USE(GBL:VersionID),TRN
  ...
  '(2)|M*@n2@0L(2)|M*@n3@'),FROM(Queue:FileDrop),IMM,MSG('Select Company'),TIP('Select Company')
                           ...
                           ENTRY(@s35),AT(179,234,153,10),USE(GBL:UserName),READONLY,SKIP
                           ...
                           STRING(@s65),AT(65,268,275,10),USE(GBL:LicenseOwnerCompany),CENTER,TRN
                           STRING(@s61),AT(65,281,275,10),USE(GBL:Copyright),CENTER,TRN
