# Change Log - Historical Releases

This file contains the complete version history for releases prior to v0.7.0.

For current releases, see [CHANGELOG.md](../../CHANGELOG.md) in the repository root.
