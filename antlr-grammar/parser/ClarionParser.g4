...
groupDeclaration
    : (anyIdentifier | LABEL | QUALIFIED_IDENTIFIER)? GROUP (LPAREN ((IDENTIFIER | QUALIFIED_IDENTIFIER | SELF) (DOT (IDENTIFIER | QUALIFIED_IDENTIFIER))*)? RPAREN)? (COMMA groupAttributes)? (DOT | NEWLINE NEWLINE* dataDeclarationList (END | DOT))
    ;

queueDeclaration
    : (anyIdentifier | LABEL | QUALIFIED_IDENTIFIER)? QUEUE (LPAREN ((IDENTIFIER | QUALIFIED_IDENTIFIER | SELF) (DOT (IDENTIFIER | QUALIFIED_IDENTIFIER))*)? RPAREN)? (COMMA queueAttributes)? (DOT | NEWLINE NEWLINE* dataDeclarationList (END | DOT))
    ;
